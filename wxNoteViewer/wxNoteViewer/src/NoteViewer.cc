...
void NoteViewer::SetupToolBar()
{
	...
	// Add tools
	m_pToolBar->AddTool(ID_CUT, _T("Cut"), m_cutBmp);
	m_pToolBar->AddTool(ID_COPY, _T("Copy"), m_copyBmp);
	m_pToolBar->AddTool(ID_PASTE, _T("Paste"), m_pasteBmp);
	m_pToolBar->AddSeparator();
	m_pToolBar->AddTool(ID_UNDO, _T("Undo"), m_undoBmp);
	m_pToolBar->AddTool(ID_REDO, _T("Redo"), m_redoBmp);
	m_pToolBar->AddSeparator();
	m_pToolBar->AddTool(ID_ZOOMIN, _T("Zoom In"), m_zoomInBmp);
	m_pToolBar->AddTool(ID_ZOOMOUT, _T("Zoom Out"), m_zoomOutBmp);
	m_pToolBar->AddSeparator();
	m_pToolBar->AddTool(ID_OPEN, _T("Open"), m_openBmp);
	m_pToolBar->AddTool(ID_SAVE, _T("Save"), m_saveBmp);
	m_pToolBar->AddTool(ID_SAVEAS, _T("Save As..."), m_saveAsBmp);
